...
![图片](./使用Safetensors和GGUF区别/640-1742109871218-6.webp)
...
![图片](./使用Safetensors和GGUF区别/640-1742109866652-3.webp)

![图片](./使用Safetensors和GGUF区别/640.webp)
...
1. ‌**Magic Number**‌用于标识文件格式的唯一标识符（如固定字符序列），确保文件类型匹配‌。‌

   | ‌**文件类型**‌  | Magic Number（十六进制） | 人类可读形式 |
   | ------------- | ------------------------ | ------------ |
