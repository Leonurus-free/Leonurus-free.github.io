...
wget https://repo.anaconda.com/archive/Anaconda3-2024.10-1-Linux-x86_64.sh --no-check-certificate
wget https://repo.anaconda.com/archive/Anaconda3-2025.06-1-Linux-x86_64.sh --no-check-certificate
